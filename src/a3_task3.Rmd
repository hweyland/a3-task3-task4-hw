...
Here I read in the urchin data and created a histogram and boxplot comparing the distribution of sizes between purple and red urchins. 
...
****The red urchin has a greater mean, median and standard deviation. Sample size for purple urchin is larger. 
...
purple_site_year <- purple_urchins %>% 
  filter(site_full %in% c("Naples Reef", "Arroyo Quemado Reef", "Carpinteria Reef", "Mohawk Reef", "Isla Vista Reef"), year_new >= 2008, year_new <= 2020) %>% 
...
ggplot(data=purple_site_year, aes(x=year_new, y=n)) +
  ...
  labs(title = "Number of Purple Urchins at Various Sites from 2008-2020", x= "Year", y="Count") +
